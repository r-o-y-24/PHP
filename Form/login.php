...
if($_SERVER['REQUEST_METHOD']=='POST'){
    if(isset(
        ...
        $qur="select * from `reginfo` where `userEMAIL` = $usEM and `userPASS` = $usPS";
        ...
        if($rowCnt==1){
            ...
            $_SESSION['uNAME']=$rowinfo['userName'];
            $_SESSION['uFather']=$rowinfo['userFather'];
            $_SESSION['uDOB']=$rowinfo['userDOB'];
